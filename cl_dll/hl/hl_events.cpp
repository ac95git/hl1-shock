...
void Game_HookEvents()
{
	...
	gEngfuncs.pfnHookEvent("events/katana_swing.sc", EV_KatanaSwing);
	gEngfuncs.pfnHookEvent("events/katana_arc.sc", EV_KatanaArc);
	gEngfuncs.pfnHookEvent("events/cleave.sc", EV_Cleave);
