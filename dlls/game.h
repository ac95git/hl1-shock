...
extern cvar_t panther_crawl_rate;
extern cvar_t panther_circle_angle;
extern cvar_t panther_circle_min;
extern cvar_t panther_circle_max;
extern cvar_t panther_turn_clamp;
extern cvar_t panther_turn_rate;
extern cvar_t panther_turn_sign;
