...
| **Frames** | One frame sprite per tier, tinted by state (white held, gold available, grey locked): a square **pad** for a Stat node, a small **chip** for Minor, a larger for Medium, a large chip with pins for a Major, the **processor** for the suit. The keystone is a Major-sized frame in **red** |
