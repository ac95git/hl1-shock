...
| [docs/PROVING_MAP.md](docs/PROVING_MAP.md) | Building the proving map — the room-by-room design that answers MAP_BRIEF's Tier 2, the unit sizes and editor rules a first-time mapper needs, the build order, and the test protocol |
