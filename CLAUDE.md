...
| [docs/SLAVE_BOSS_CHECKLIST.md](docs/SLAVE_BOSS_CHECKLIST.md) | **Before building on anything from the slave boss build of 2026-09-23** — the Pulse at 1 s, the innate Discharge, the Barrier, the boss. One commit per slice, none verified in game; the rows Andrei reports against |
