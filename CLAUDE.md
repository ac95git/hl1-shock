...
| [docs/STEALTH_CHECKLIST.md](docs/STEALTH_CHECKLIST.md) | **Before any stealth work.** The 5f test rows Andrei reports against; until every row has a result, nothing under pillar 6 is touched. Written 2026-09-17 |
